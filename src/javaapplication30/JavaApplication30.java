...
public class JavaApplication30 {
    ...
    if(op==1){
       ...
       if(uname.equals(admin.getuser())&&pass.equals(admin.getPass())){
            System.out.println("1.Add  ");
             System.out.println("2.View  ");
              ...
              double due;
               switch(op2){              
                   case 1:    System.out.println("Enter ID  ");id=in.nextInt();   System.out.println("Enter The Name : "); name=in.next();
                   u[sizU]=new User(id,name);sizU++;break;
                   
                   
                   case 2:for(int i=0;i<10;i++){
                       System.out.println(u[i].getter());
                   };break;
              ...
              double due;
               switch(op2){              
                   ...
                   case 3: System.out.println("Enter ID  ");id=in.nextInt();  
                       for(int i=0;i<10;i++){
                       if(id==(s[i].getid())){
                          System.out.println("Enter ID  ");id=in.nextInt();   System.out.println("Enter The Name : "); name=in.next();
                    System.out.println("Enter The Due Fee : "); due=in.nextDouble();
